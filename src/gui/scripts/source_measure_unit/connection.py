"""Connection page for Source Measure Unit hardware configuration."""
...
class SMUConnectionPage(BaseHardwarePage):
    """Connection configuration page for Source Measure Unit.
    ...
    def __init__(
        ...
        # ==== Title ====
        title = QLabel("Source Measure Unit – Connection")
        ...
        smu_layout.setContentsMargins(12, 18, 12, 12)
    ...
    def _on_connect(self) -> None:
        ...
        self._log("Connecting to SMU hardware...")
        self._start_task(self.service.connect_only())

    def _on_disconnect(self) -> None:
        """Disconnect from SMU hardware."""
        if not self.service:
            return
        self._log("Disconnecting from SMU hardware...")
