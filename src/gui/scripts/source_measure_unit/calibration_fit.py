"""Calibration fit page for Source Measure Unit."""
...
class SMUCalFitPage(BaseHardwarePage):
    """Calibration fit page for SMU.
    ...
    def __init__(
        ...
        # ==== Title ====
        title = QLabel("Source Measure Unit – Calibration Fit")
        ...
        desc_label = QLabel(
            ...
            "• Analyzes all measurement ranges\n"
            "• Optionally writes calibration to device EEPROM"
        )
